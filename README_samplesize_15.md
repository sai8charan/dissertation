...
```bash
python experiments/run_baselines.py --max_samples 15 --no_fcs
```
...
python experiments/run_pipeline.py --max_samples 15 --safety_mode dynamic

# Fixed threshold baseline mode
python experiments/run_pipeline.py --max_samples 15 --safety_mode fixed
...
```bash
python experiments/run_ablations.py --ablation all --max_samples 15
```
